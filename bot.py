...
async def webhook():
    ...
    if application is None:
        return "Application is not initialized", 500
...
def set_webhook():
    ...
    response = requests.post(
        f'https://api.telegram.org/bot{os.getenv("BOT_TOKEN")}/setWebhook',
...
# Main function to initialize the bot and run the application
async def main():
    global application
